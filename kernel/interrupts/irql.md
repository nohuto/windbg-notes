...
You can display the `Irql` of a processor via its field in the kernel processor control region (`KPCR`) structure (see '[Processor Control Block](https://noverse.dev/docs/windbg-notes/kernel/prcb/)' for context):
