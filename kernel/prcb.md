...
PRCB for Processor 0 at fffff80065eb2180:
Current IRQL -- 0
Threads--  Current ffff8203929d5080 Next 0000000000000000 Idle fffff8006af4d700
Processor Index 0 Number (0, 0) GroupSetMember 1
Interrupt Count -- 001692fb
Times -- Dpc    00000003 Interrupt 00000014 
...
lkd> dt nt!_KPRCB
   ...
   +0x6d0 BpbRetpolineExitSpecCtrl : Uint2B
   +0x6d2 BpbTrappedRetpolineExitSpecCtrl : Uint2B
   +0x6d4 BpbTrappedBpbState : Uint2B
   +0x6d4 BpbTrappedCpuIdle : Pos 0, 1 Bit
   +0x6d4 BpbTrappedFlushRsbOnTrap : Pos 1, 1 Bit
   +0x6d4 BpbTrappedIbpbOnReturn : Pos 2, 1 Bit
   +0x6d4 BpbTrappedIbpbOnTrap : Pos 3, 1 Bit
   +0x6d4 BpbTrappedIbpbOnRetpolineExit : Pos 4, 1 Bit
   +0x6d4 BpbTrappedFlushRsbOnReturn : Pos 5, 1 Bit
   +0x6d4 BpbTrappedFlushRsbOnRetpolineExit : Pos 6, 1 Bit
   +0x6d4 BpbTrappedBpbStateReserved : Pos 7, 1 Bit
   +0x6d4 BpbTrappedBpbStateReserved2 : Pos 8, 8 Bits
   +0x6d6 BpbRetpolineState : UChar
   +0x6d6 BpbRunningNonRetpolineCode : Pos 0, 1 Bit
   +0x6d6 BpbIndirectCallsSafe : Pos 1, 1 Bit
   +0x6d6 BpbRetpolineEnabled : Pos 2, 1 Bit
   +0x6d6 BpbRetpolineStateReserved : Pos 3, 5 Bits
   +0x6d7 PrcbPad12b       : UChar
   +0x6d0 PrcbPad12a       : Uint8B
   +0x6d8 TrappedSecurityDomain : Uint8B
   +0x6e0 BpbState         : Uint2B
   +0x6e0 BpbCpuIdle       : Pos 0, 1 Bit
   +0x6e0 BpbFlushRsbOnTrap : Pos 1, 1 Bit
   +0x6e0 BpbIbpbOnReturn  : Pos 2, 1 Bit
   +0x6e0 BpbIbpbOnTrap    : Pos 3, 1 Bit
   +0x6e0 BpbIbpbOnRetpolineExit : Pos 4, 1 Bit
   +0x6e0 BpbFlushRsbOnReturn : Pos 5, 1 Bit
   +0x6e0 BpbFlushRsbOnRetpolineExit : Pos 6, 1 Bit
   +0x6e0 BpbDivideOnReturn : Pos 7, 1 Bit
   +0x6e0 VerwOnNonKvaReturn : Pos 8, 1 Bit
   +0x6e0 FlushBhbOnTrap   : Pos 9, 1 Bit
   +0x6e0 Spare            : Pos 10, 6 Bits
   +0x6e2 BpbFeatures      : UChar
   +0x6e2 BpbClearOnIdle   : Pos 0, 1 Bit
   +0x6e2 BpbEnabled       : Pos 1, 1 Bit
   +0x6e2 BpbSmep          : Pos 2, 1 Bit
   +0x6e2 BpbKCet          : Pos 3, 1 Bit
   +0x6e2 BhbFlushSequence : Pos 4, 2 Bits
   +0x6e2 VerwOnIdle       : Pos 6, 1 Bit
   +0x6e2 BpbFeaturesReserved : Pos 7, 1 Bit
   +0x6e3 PrcbPad12e       : [1] UChar
   +0x6e4 BpbCurrentSpecCtrl : Uint2B
   +0x6e6 BpbKernelSpecCtrl : Uint2B
   +0x6e8 BpbNmiSpecCtrl   : Uint2B
   +0x6ea BpbUserSpecCtrl  : Uint2B
   +0x6ec PairRegister     : Int2B
   +0x6ee PrcbPad12d       : [2] UChar
   +0x6d8 PrcbPad12c       : [3] Uint8B
   ...
   +0x81dc PrcbPad83        : [23] Uint4B
   +0x8238 NumberOfSecureFaults : Uint8B
